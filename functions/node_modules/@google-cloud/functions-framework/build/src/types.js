...
exports.isValidSignatureType = exports.SignatureType = exports.FUNCTION_STATUS_HEADER_FIELD = void 0;
...
const isValidSignatureType = (x) => {
    return exports.SignatureType.includes(x);
};
exports.isValidSignatureType = isValidSignatureType;
